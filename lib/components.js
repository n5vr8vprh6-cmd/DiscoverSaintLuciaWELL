  ...
  return `<div class="island" data-island>
    <div class="island-figure">
      <svg class="island-svg" viewBox="${esc(island.viewBox)}" role="img" aria-labelledby="${titleId}" focusable="false">
        ...
        <desc>${esc(island.attribution || '')}. Pins are the shortlisted properties, coloured by the village they answer for this traveller.</desc>
        <path class="island-land" d="${island.outline}"></path>
        ${towns}
        ${pinSvg}
      </svg>
      <p class="island-caption"><span class="coords">13°54′N 60°58′W</span><span class="island-attrib">${esc(island.attribution || '')}</span></p>
    </div>
