...
function compass(s) {
  ...
  function compassSvg(points, centre) {
    return `<svg viewBox="0 0 620 620" class="compass" role="img"
...
function compassRing(points, centre) {
  const html = compass({ id: 'x', points, center: centre, headline: '', eyebrow: '' });
  ...
  <div class="wrap">
    ...
    <div class="finder-app" id="finder-app" hidden>
      ...
      <div class="result-compass-figure" id="finder-compass" hidden>
        ${compassRing(s.compassPoints || [], s.compassCentre || 'YOUR JOURNEY')}
      </div>
