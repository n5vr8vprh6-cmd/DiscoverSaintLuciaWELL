/* Ambient cinemagraph playback — ported verbatim from the Foundations page,
   which is where this ladder was proven. Do not "simplify" it; every branch
   below exists because of a real failure mode.
