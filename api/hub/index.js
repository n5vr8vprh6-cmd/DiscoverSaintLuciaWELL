...
const { hubPage, esc, emptyState, STAGE_LABEL, WINDOW_LABEL, since } = require('../_lib/hub-render.js');
const { journeysFor, funnelFor, needsAttention } = require('../_lib/hub-data.js');
